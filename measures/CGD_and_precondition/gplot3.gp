...
plot 'CGD.csv'  using 5:4 smooth unique title "no precondition" with points pt 7 lc rgb "red", \
     'PCCGD.csv'  using 5:4 smooth unique title "precondition" with points pt 6 lc rgb "blue"
