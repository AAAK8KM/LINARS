...
plot 'CGD.csv'  using 1:2 smooth unique title "no precondition" with points pt 7 lc rgb "red", \
     'PCCGD.csv'  using 1:2 smooth unique title "precondition" with points pt 6 lc rgb "blue"